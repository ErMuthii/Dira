...
const Assessment = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      question: "I like to have clear examples to follow.",
      options: [
        { value: 1, label: "Strongly Disagree" },
        { value: 2, label: "Disagree" },
        { value: 3, label: "Neutral" },
    ...
    },
    {
      ...
      question: "I wouldn't mind working 8 hours per day in the office.",
      options: [
        { value: 1, label: "Strongly Disagree" },
        { value: 2, label: "Disagree" },
        { value: 3, label: "Neutral" },
    ...
    },
    {
      ...
      question: "I am good at keeping records at my work.",
      options: [
        { value: 1, label: "Strongly Disagree" },
        { value: 2, label: "Disagree" },
        { value: 3, label: "Neutral" },
